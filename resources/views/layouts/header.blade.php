    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-6 px-4">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex items-center flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
          <li>
            <a href="{{ route('home.index') }}" class="font-bold underline-offset-8 {{ request()->is('/') ? 'underline decoration-4 decoration-yellow-300' : '' }} block py-2 px-3 rounded md:bg-transparent md:p-0 hover:underline decoration-4 underline-offset-4 decoration-yellow-300" aria-current="page">Home</a>
          </li>
          <li>
            <a href="{{ route('services.index') }}" class="font-bold underline-offset-8 {{ request()->is('services*') ? 'underline decoration-4 decoration-yellow-300' : '' }} block py-2 px-3 rounded md:bg-transparent md:p-0 hover:underline decoration-4 underline-offset-4 decoration-yellow-300">Services</a>
          </li>
          <li>
            <a href="{{ route('works.index') }}" class="font-bold underline-offset-8 {{ request()->is('works*') ? 'underline decoration-4 decoration-yellow-300' : '' }} block py-2 px-3 rounded md:bg-transparent md:p-0 hover:underline decoration-4 underline-offset-4 decoration-yellow-300">Works</a>
          </li>
          <li>
            <a href="{{ route('about.index') }}" class="font-bold underline-offset-8 {{ request()->is('about-us') ? 'underline decoration-4 decoration-yellow-300' : '' }} block py-2 px-3 rounded md:bg-transparent md:p-0 hover:underline decoration-4 underline-offset-4 decoration-yellow-300">About us</a>
          </li>
          <li>
            <a href="{{ route('contact.index') }}" class="font-bold py-1 space-x-1 items-center px-3 bg-yellow-300 hover:bg-yellow-200 rounded-full text-slate-900 flex">
              <span>
                Partnership
              </span>
              <span>
