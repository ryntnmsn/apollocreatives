...
<head>
    ...
    <title>Apollo Creatives Ph | Thate Maristela</title>
        ...
        <div class="flex justify-center h-full">
            <div class="w-[640px] mx-auto relative">
                <div class="relative">
                    ...
                    <img src="{{ asset('images/members/thate.png') }}" alt="">
                    <div class="absolute bottom-0 left-0 right-0 pb-20">
                        <div class="flex justify-center">
                            <div class="p-5 text-center flex flex-col space-y-4">
                                <h1 class="text-8xl yeseva">Thate</h1>
                                <h2 class="text-base text-slate-400">Chief Creative Officer</h2>
                            </div>
                        </div>
                    </div>
                </div>
